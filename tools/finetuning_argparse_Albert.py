...
def get_argparse():
    ...
    ## 预训练模型路径&名称
    parser.add_argument("--model_name_or_path", default="prev_trained_model/albert_fin_small", type=str,
    ...
    parser.add_argument("--config_name", default="prev_trained_model/albert_fin_small/config.json", type=str,
                        help="【配置文件】Pretrained config name or path if not the same as model_name")

    parser.add_argument("--tokenizer_name", default="prev_trained_model/albert_fin_small/vocab.txt", type=str,
