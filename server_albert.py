...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", default="albert", type=str, help="模型类型")
    parser.add_argument("--model_path", default="/root/zhanghan/ALBERT_CRF_W_FIX/bushu/server_model/albert", type=str, help="模型路径")
    parser.add_argument("--use_GPU", default=True, type=bool, help="使用GPU")
    parser.add_argument("--batch_size", default=64, type=int, help="sents num of one batch")
