...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="bushu/server_model/bert", type=str, help="模型路径")
    parser.add_argument("--use_GPU", default=True, type=bool, help="使用GPU")
    parser.add_argument("--batch_size", default=16, type=int, help="sents num of one batch")
